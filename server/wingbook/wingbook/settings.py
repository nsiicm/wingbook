"""
Django settings for wingbook project.
...
SECRET_KEY = 'django-insecure-ay0bjm6-0f$42_t^6=sb5*)8-b^ckfega3b-$6w)2))fmgghh7'
...
WSGI_APPLICATION = 'wingbook.wsgi.application'
